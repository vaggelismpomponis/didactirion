...
import { Calculator, Info, RotateCcw, ArrowRight } from "lucide-react";
...
export function PointsCalculatorClient({ initialContent }: { initialContent: typeof defaultCalculatorContent }) {
  const [content, setContent] = React.useState<typeof defaultCalculatorContent>(initialContent);
  ...
  const handlePreviewUpdate = React.useCallback((override: Record<string, any>) => {
    setContent(mergeContent(defaultCalculatorContent, override) as typeof defaultCalculatorContent);
  }, []);
  ...
  return (
    <div className="flex flex-col">
      <PreviewListener pageKey="points-calculator" onContentUpdate={handlePreviewUpdate} />
