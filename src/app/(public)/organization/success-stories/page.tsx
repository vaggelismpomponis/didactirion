  ...
  return (
    <div className="flex flex-col gap-12 pb-16">
      ...
      <section className="container mx-auto px-4 py-16 mt-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-900 to-indigo-950 text-white shadow-xl shadow-blue-900/10">
          ...
          <div className="relative px-6 py-12 md:py-16 text-center max-w-2xl mx-auto space-y-6">
            <h2 className="text-3xl font-black tracking-tight text-white">Γίνε ο επόμενος επιτυχών!</h2>
            ...
            <div className="pt-2">
              <Button
                asChild
                size="lg"
                className="bg-white text-primary hover:bg-white/90 font-bold px-8 h-12 shadow-md rounded-xl inline-flex items-center gap-2"
              >
                <Link href="/contact">
                  Ξεκίνα Σήμερα <ArrowRight className="w-4 h-4" />
                </Link>
              </Button>
            </div>
          </div>
