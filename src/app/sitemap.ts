...
const STATIC_ROUTES: Array<{
  ...
  { path: "/curricula/junior-high-a", changeFrequency: "monthly", priority: 0.8 },
  { path: "/curricula/junior-high-b", changeFrequency: "monthly", priority: 0.8 },
  { path: "/curricula/junior-high-c", changeFrequency: "monthly", priority: 0.8 },
  { path: "/curricula/high-school-a", changeFrequency: "monthly", priority: 0.85 },
  { path: "/curricula/high-school-b", changeFrequency: "monthly", priority: 0.85 },
  { path: "/curricula/high-school-c", changeFrequency: "monthly", priority: 0.85 },
