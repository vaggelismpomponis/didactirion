...
const PAGES: Array<{
  ...
  { key: "curricula/junior-high-a", label: "Α' Γυμνασίου", icon: GraduationCap, route: "/curricula/junior-high-a", supportsInlineEdit: true },
  { key: "curricula/junior-high-b", label: "Β' Γυμνασίου", icon: GraduationCap, route: "/curricula/junior-high-b", supportsInlineEdit: true },
  { key: "curricula/junior-high-c", label: "Γ' Γυμνασίου", icon: GraduationCap, route: "/curricula/junior-high-c", supportsInlineEdit: true },
  { key: "curricula/high-school-a", label: "Α' Λυκείου", icon: GraduationCap, route: "/curricula/high-school-a", supportsInlineEdit: true },
  { key: "curricula/high-school-b", label: "Β' Λυκείου", icon: GraduationCap, route: "/curricula/high-school-b", supportsInlineEdit: true },
  { key: "curricula/high-school-c", label: "Γ' Λυκείου", icon: GraduationCap, route: "/curricula/high-school-c", supportsInlineEdit: true },
