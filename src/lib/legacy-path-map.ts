...
const LEGACY_PATH_MAP: Record<string, string> = {
  ...
  "γυμνάσιο": "/curricula/junior-high-a",
  "α-λυκείου": "/curricula/high-school-a",
  "β-λυκείου": "/curricula/high-school-b",
  "γ-λυκείου": "/curricula/high-school-c",
  "g-lykeiou": "/curricula/high-school-c",
  "απόφοιτοι": "/curricula/alumni",
  "εισαγωγή-στα-πρότυπα": "/curricula/model-schools",
  "μαθήματα-προγραμματισμού-σε-scratch": "/curricula/junior-high-a",
  ...
  epikoinonia: "/contact",
  contact: "/contact",
  "φυσική": "/curricula/high-school-a",
  fysiki: "/curricula/high-school-a",
  register: "/",
};
